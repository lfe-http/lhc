...
(defun new (scheme netloc-str path params query fragment opts)
  (let ((netloc (parse-netloc netloc-str)))
    (new `(#(scheme ,scheme)
           #(username ,(get-username netloc))
           #(password ,(get-password netloc))
           #(host ,(get-host netloc))
           #(port ,(get-port netloc))
           #(path ,path)
           #(params ,params)
           #(query ,query)
           #(fragment ,fragment))
